...
public class SlicedFilledImageTween
{
    public static Tween UIFillAmount(SlicedFilledImage image, float endValue, float duration, Ease ease = Ease.OutQuad)
    {
        if (image == null)
        {
            Debug.LogError("Tween.UIFillAmount(SlicedFilledImage): image is null");
            return default;
        }
        ...
        return Tween.Custom(
            ...
            endValue,
            duration,
            (target, value) => target.fillAmount = value,
            ease
        );
    }

    public static Tween UIFillAmount(SlicedFilledImage image, float startValue, float endValue, float duration, Ease ease = Ease.OutQuad)
    {
        if (image == null)
        {
            Debug.LogError("Tween.UIFillAmount(SlicedFilledImage): image is null");
    ...
    public static Tween UIFillAmount(SlicedFilledImage image, float endValue, TweenSettings<float> settings)
    {
        if (image == null)
        {
            Debug.LogError("Tween.UIFillAmount(SlicedFilledImage): image is null");
    ...
    public static Tween UIFillAmount(SlicedFilledImage image, float startValue, float endValue, TweenSettings<float> settings)
    {
        if (image == null)
        {
            Debug.LogError("Tween.UIFillAmount(SlicedFilledImage): image is null");
